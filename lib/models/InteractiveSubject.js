  ...
  InteractiveSubject = (function(_super) {
    ...
    InteractiveSubject.fromJSON = function(json) {
      ...
      for (_i = 0, _len = json.length; _i < _len; _i++) {
        result = json[_i];
        if (result.recent.subjects[0].metadata.survey === 'sloan') {
          item = InteractiveSubject.create({
            ...
            absolute_brightness: (_ref = result.recent.subjects[0].metadata.mag) != null ? _ref.abs_r : void 0,
            apparent_brightness: (_ref1 = result.recent.subjects[0].metadata.mag) != null ? _ref1.r : void 0,
            color: ((_ref2 = result.recent.subjects[0].metadata.mag) != null ? _ref2.u : void 0) - ((_ref3 = result.recent.subjects[0].metadata.mag) != null ? _ref3.r : void 0),
