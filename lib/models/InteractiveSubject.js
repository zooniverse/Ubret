(function() {
  ...
  InteractiveSubject = (function(_super) {
    ...
    InteractiveSubject.fromJSON = function(json) {
      var item, result, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _results;
      InteractiveSubject.lastFetch = new Array;
      _results = [];
      for (_i = 0, _len = json.length; _i < _len; _i++) {
        result = json[_i];
        if (((_ref = result.recent.subjects[0]) != null ? (_ref1 = _ref.metadata) != null ? _ref1.survey : void 0 : void 0) === 'sloan') {
          item = InteractiveSubject.create({
            ...
            absolute_brightness: (_ref2 = result.recent.subjects[0].metadata.mag) != null ? _ref2.abs_r : void 0,
            apparent_brightness: (_ref3 = result.recent.subjects[0].metadata.mag) != null ? _ref3.r : void 0,
            color: ((_ref4 = result.recent.subjects[0].metadata.mag) != null ? _ref4.u : void 0) - ((_ref5 = result.recent.subjects[0].metadata.mag) != null ? _ref5.r : void 0),
