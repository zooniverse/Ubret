(function() {
  ...
  InteractiveSubject = (function(_super) {
    ...
    InteractiveSubject.configure('InteractiveSubject', 'redshift', 'color', 'subject', 'classification', 'type', 'counters', 'image', 'zooniverse_id', 'absolute_brightness', 'apparent_brightness', 'absolute_size');
      ...
      for (_i = 0, _len = json.length; _i < _len; _i++) {
        ...
        if (result.recent.subject.metadata.survey === 'sloan') {
          item = InteractiveSubject.create({
            ...
            redshift: result.recent.subject.metadata.redshift != null,
            ...
            absolute_size: result.recent.subject.metadata.absolute_size != null
          });
