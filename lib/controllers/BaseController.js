(function() {
  ...
  BaseController = (function(_super) {
    ...
    BaseController.prototype.addSelectionFilter = function(filter) {
      return this.selectionFilter = filter;
    };
    ...
    BaseController.prototype.selectData = function() {
      return this.selectedData = _.filter(this.filteredData(), this.selectionFitler);
    };
