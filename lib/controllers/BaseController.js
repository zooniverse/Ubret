(function() {
  var BaseController, GalaxyZooSubject, InteractiveSubject, SDSS3SpectralData, SkyServerSubject, Spine, pubSub, _,
  ...
  BaseController = (function(_super) {
    ...
    function BaseController(params) {
      ...
      this.bindTool = __bind(this.bindTool, this);

      this.setBindOptions = __bind(this.setBindOptions, this);
    ...
    BaseController.prototype.setBindOptions = function(source, params) {
      if (params == null) {
        params = '';
      }
      this.bindOptions = {
      ...
      if (params) {
        return this.bindOptions = _.extend(this.bindOptions, {
          type: 'api',
          params: params
        });
      } else {
    ...
    BaseController.prototype.bindTool = function(source, params) {
      ...
      this.setBindOptions(source, params);
      if (this.bindOptions.type === 'api') {
        return this.getDataSource(source, params);
      } else if (this.bindOptions.type === 'channel') {
    ...
    BaseController.prototype.select = function(item_id) {};

    BaseController.prototype.selectKey = function(key) {};
    ...
    BaseController.prototype.process = function(message) {
      switch (message.message) {
        ...
        case 'selected_key':
          return this.selectKey(message.key);
      }
    };
