(function() {
  var BaseController, Spine, pubSub, _,
  ...
  BaseController = (function(_super) {
    ...
    BaseController.prototype.subscribe = function(channel, callback) {
      this.subscription = pubSub.subscribe(channel, callback);
      return this.trigger('subscribed', channel);
    };

    BaseController.prototype.unsubscribe = function() {
    ...
    BaseController.prototype.process = function(message) {
      switch (message.message) {
        ...
        case 'receive_data':
          return this.receiveData(message.data);
      }
    };
