(function() {
  var BaseController, GalaxyZooSubject, Settings, SkyServerSubject, Spine, eco, pubSub, _,
  ...
  BaseController = (function(_super) {
    ...
    BaseController.prototype.requireTemplate = function(modulePath, context) {
      return eco(require(modulePath), context);
    };
