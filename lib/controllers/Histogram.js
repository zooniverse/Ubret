(function() {
  ...
  Histogram = (function(_super) {
    ...
    Histogram.prototype.createXAxis = function(format) {
      ...
      return Histogram.__super__.createXAxis.call(this, xTicks, this.variable, format);
    };
    ...
    Histogram.prototype.start = function() {
      ...
      this.createXAxis(d3.format(',.02f'));
      this.createYAxis();
