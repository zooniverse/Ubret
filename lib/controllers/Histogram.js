(function() {
  ...
  Histogram = (function(_super) {
    ...
    Histogram.prototype.createGraph = function() {
      ...
      svg = d3.select("#" + channel + " svg").attr('width', graphWdith).attr('height', graphHeight).append('g').attr('transform', "translate(" + margin.left + ", " + margin.bottom + ")");
