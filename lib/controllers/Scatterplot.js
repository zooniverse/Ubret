(function() {
  ...
  Scatterplot = (function(_super) {
    ...
    Scatterplot.prototype.addAxis = function(options) {
      ...
      this.graph.xAxis.axisLabel(this.prettyKey(this.xAxisKey)).tickFormat(d3.format(this.graph_options.x_tick_format));
      return this.graph.yAxis.axisLabel(this.prettyKey(this.yAxisKey)).tickFormat(d3.format(this.graph_options.y_tick_format));
    };
