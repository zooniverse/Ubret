(function() {
  ...
  Scatterplot = (function(_super) {
    ...
    function Scatterplot() {
      ...
      this.addSelectionFilter = __bind(this.addSelectionFilter, this);
    ...
    Scatterplot.prototype.addSelectionFilter = function(filter, color) {
      this.selectionFilter = filter;
      return this.selectionColor = color;
    };

    Scatterplot.prototype.removeSelectionFilter = function() {
      delete this.selectionFilter;
      return delete this.selectionColor;
    };

    Scatterplot.prototype.drawAxes = function() {
      var data, selected, xAxis, xDomain, yAxis, yDomain,
        _this = this;
      if (this.filteredData.length !== 0) {
        ...
        if (this.selectionFilter) {
          selected = _.filter(data, this.selectionFilter);
          data = _.map(data, function(d) {
            if (__indexOf.call(selected, d) >= 0) {
              return d.color = _this.selectionColor;
            }
          });
          console.log(data);
        }
