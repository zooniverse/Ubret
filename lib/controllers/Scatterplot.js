(function() {
  ...
  Scatterplot = (function(_super) {
    ...
    function Scatterplot() {
      ...
      console.log(this.xAxisKey, this.yAxisKey);
    ...
    Scatterplot.prototype.addFieldsToAxes = function() {
      this.graph.xAxis.axisLabel(this.xAxisKey);
      this.addData();
      this.graph.yAxis.axisLabel(this.yAxisKey);
      return this.addData();
    };
    ...
    Scatterplot.prototype.addAxis = function(options) {
      ...
      this.graph.xAxis.axisLabel(this.xAxisKey).tickFormat(d3.format(this.graph_options.x_tick_format));
      return this.graph.yAxis.axisLabel(this.yAxisKey).tickFormat(d3.format(this.graph_options.y_tick_format));
    };
