...
(function() {
  ...
  Graph = (function(_super) {
    ...
    Graph.prototype.clearFilters = function() {
      var dimension, key, _ref, _results;
      _ref = this.dimensions;
      _results = [];
      for (key in _ref) {
        dimension = _ref[key];
        _results.push(dimension.filterAll());
      }
      return _results;
    };
...
(function() {
  ...
  Histogram = (function(_super) {
    ...
    Histogram.prototype.createGraph = function() {
      ...
      this.svg.append('g').attr('class', 'x axis').attr('transform', "translate(0, " + this.graphHeight + ")").call(xAxis);
      this.svg.append('g').attr('class', 'y axis').attr('transform', "translate(0, 0)").call(yAxis);
      this.svg.append('text').attr('class', 'x label').attr('text-anchor', 'middle').attr('x', this.graphWidth / 2).attr('y', this.graphHeight + 35).text(this.formatKey(this.xAxis));
